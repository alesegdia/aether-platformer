...
<tileset version="1.10" tiledversion="1.10.2" name="tileset" tilewidth="32" tileheight="32" tilecount="64" columns="8">
 ...
 <wangsets>
  <wangset name="WalkableAreas" type="corner" tile="-1">
   ...
   <wangcolor name="Air" color="#18d8ff" tile="-1" probability="1"/>
   <wangcolor name="BackWall" color="#0000ff" tile="-1" probability="1"/>
   ...
   <wangtile tileid="21" wangid="0,1,0,1,0,2,0,1"/>
   <wangtile tileid="22" wangid="0,1,0,2,0,1,0,1"/>
   <wangtile tileid="24" wangid="0,2,0,3,0,2,0,2"/>
   <wangtile tileid="25" wangid="0,2,0,3,0,3,0,2"/>
   <wangtile tileid="26" wangid="0,2,0,2,0,3,0,2"/>
   <wangtile tileid="27" wangid="0,2,0,2,0,2,0,2"/>
   <wangtile tileid="32" wangid="0,3,0,3,0,2,0,2"/>
   <wangtile tileid="33" wangid="0,3,0,3,0,3,0,3"/>
   <wangtile tileid="34" wangid="0,2,0,2,0,3,0,3"/>
   <wangtile tileid="35" wangid="0,3,0,3,0,3,0,2"/>
   <wangtile tileid="36" wangid="0,2,0,3,0,3,0,3"/>
   <wangtile tileid="40" wangid="0,3,0,2,0,2,0,2"/>
   <wangtile tileid="41" wangid="0,3,0,2,0,2,0,3"/>
   <wangtile tileid="42" wangid="0,2,0,2,0,2,0,3"/>
   <wangtile tileid="43" wangid="0,3,0,3,0,2,0,3"/>
